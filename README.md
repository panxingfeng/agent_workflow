...
> **已完成:** 单agent的快速创建，微信支持工具(聊天，搜索，天气，语音)
...
- ✅ vchat微信接入（支持聊天，搜索工具，天气查询，语音工具（音频的生成[结果1](./images/wechat_audio_result-f5tts.png)  [结果2](./images/wechat_audio_result-gptsovits.png)））
  ```
  tools = [
     WeatherTool(),
     FileConverterTool(),
