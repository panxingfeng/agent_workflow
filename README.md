...
- ✅ vchat微信接入（支持聊天，搜索工具，天气查询，语音工具（音频的生成[结果1](./images/wechat_audio_result-f5tts.png)  [结果2](./images/wechat_audio_result-gptsovits.png) 语音识别结果[结果](./images/speech_result_wechat.png)）、文件转换工具[示例结果](./images/pdf_converter_wechat.png)）
  ```
  tools = [
     WeatherTool(),
     FileConverterTool(),
